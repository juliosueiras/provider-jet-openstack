...
PROJECT_NAME := provider-jet-openstack
PROJECT_REPO := github.com/juliosueiras/$(PROJECT_NAME)

export TERRAFORM_VERSION := 1.1.6

export TERRAFORM_PROVIDER_SOURCE := terraform-provider-openstack/openstack
export TERRAFORM_PROVIDER_VERSION := 1.47.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-openstack
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://releases.hashicorp.com/terraform-provider-openstack/1.47.0
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-openstack_v1.47.0
...
IMAGES = provider-jet-openstack provider-jet-openstack-controller
