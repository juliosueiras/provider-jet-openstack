...
import (
	...
	v1alpha1 "github.com/juliosueiras/provider-jet-openstack/apis/containerinfra/v1alpha1"
)

// Setup adds a controller that reconciles ClustertemplateV1 managed resources.
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	name := managed.ControllerName(v1alpha1.ClustertemplateV1_GroupVersionKind.String())
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		For(&v1alpha1.ClustertemplateV1{}).
