...
func (mg *ObjectV1) GetTerraformResourceType() string {
	return "openstack_objectstorage_object_v1"
}
...
// LateInitialize this ObjectV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ObjectV1) LateInitialize(attrs []byte) (bool, error) {
	params := &ObjectV1Parameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
...
func (mg *TempurlV1) GetTerraformResourceType() string {
	return "openstack_objectstorage_tempurl_v1"
}
...
// LateInitialize this TempurlV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *TempurlV1) LateInitialize(attrs []byte) (bool, error) {
	params := &TempurlV1Parameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
