...
func (mg *ContainerV1) GetTerraformResourceType() string {
	return "openstack_keymanager_container_v1"
}
...
func (mg *OrderV1) GetTerraformResourceType() string {
	return "openstack_keymanager_order_v1"
}
...
// LateInitialize this OrderV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *OrderV1) LateInitialize(attrs []byte) (bool, error) {
	params := &OrderV1Parameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
...
// LateInitialize this SecretV1 using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SecretV1) LateInitialize(attrs []byte) (bool, error) {
	params := &SecretV1Parameters{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
